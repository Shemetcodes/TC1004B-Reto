var opts = {
  ...
  percentColors: [[0.0, "#FEC5E5" ], [60, "#FFE12B"], [80, "#ED2939"]]   // Make color react according to the position of the needle
  
};

var target = document.getElementById('myGauge3'); // your canvas element
